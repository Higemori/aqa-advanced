...
const userPromise = fetchClass.fetchData('https://jsonplaceholder.typicode.com/users/1');
const todoPromise = fetchClass.fetchData('https://jsonplaceholder.typicode.com/todos/1');
